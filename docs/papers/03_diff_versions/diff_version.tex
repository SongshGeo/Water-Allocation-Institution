...
.
}\DIFaddend Our results show that while 98-UBR decreased water use in the YRB, 87-WAS increased it \DIFaddbegin \DIFadd{by $8.57\%$}\DIFaddend .
...
}\DIFaddend (1) \DIFdelbegin \DIFdel{When links }\DIFdelend The water quotas of 87-WAS (or the initial water rights) went through a stage of ``bargaining'' among stakeholders (from 1982 to 1987) \cite{wang2019a, wang2019d}, where each province attempted to demonstrate its development potential related to water use.
