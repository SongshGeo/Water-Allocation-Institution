...
We depict the relationship of multi-period profit and water use $x_{i,0}$ in different horizons in Figure~\ref{fig:technology}%%此处引用图片
...
We depict the relationship of multi-period net income and water use $x_{i,0}$ in different horizons in Figure~\ref{fig:remote}%此处引用图片
