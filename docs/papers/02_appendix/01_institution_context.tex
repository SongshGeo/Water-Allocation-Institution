...
Water allocation schemes are widespread in large river basin management programs throughout the world (see \textit{Appendix} Figure~\ref{fig:world}) \cite{speed2013}.
...
The official documents in 1987 (\href{http://www.gov.cn/zhengce/content/2011-03/30/content_3138.htm#}{http://www.mwr.gov.cn}, last access: \today) clearly convey the following key points:

\begin{itemize}
	% 该政策面向的目标是各省（区域），黄委会没有被提及
	\item The policy is aimed at related provinces (or regions in the same administrative level).
	% 政策制定的首要考虑是解决断流问题
...
(\href{http://www.mwr.gov.cn/ztpd/2013ztbd/2013fxkh/fxkhswcbcs/cs/flfg/201304/t20130411_433489.html}{http://www.mwr.gov.cn}, last access: \today) clearly convey the following key points:
...
% 基于上述分析，我们抽象出了如正文图2中所展示的流域水资源分配制度的运行结构，并将研究时段选择在1979到2008之间。
% On the basis of the above analysis, we abstracted the operational structure of the water resource allocation institution of the YRB as shown in Figure 2 of the main text, focusing on the period between 1979 and 2008. By comparing the net effects of three different institutional structures split by the two institutional shifts, we were able to reach a stronger understanding of the influence of structural alignments under the same basin (previous structure-based analysis usually focus on a certain type of systems but with different geographic contexts).
...
Based on the above documents, we abstracted the structural changes of SES (see \textit{Appendix S2}) after the two institutional changes, as shown in Figure~\ref{structure}~C.
