...
% \begin{figure*}[!htb]
%     \centering
%     \includegraphics[width=12cm]{diagrams/world_institutions.pdf}
% 	\caption{
...
% Based on the above documents, we abstracted the structural changes of SES after the two institutional changes, as shown in the main text \textbf{Figure 2C}.
