...
\begin{document}
\title{Appendix for: Institutional shifts and sustainable water use of the Yellow River Basin}
...
\setcounter{figure}{0}
\setcounter{table}{0}
\input{01_institution_context.tex}
...
\setcounter{figure}{0}
\setcounter{table}{0}
\input{04_theoretical_model.tex}
