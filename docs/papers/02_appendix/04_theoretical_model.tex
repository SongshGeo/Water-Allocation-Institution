...
In order to understand the mechanisms through which the SES structure impacts provincial water use, we developed a dynamic economic model to analyze how institutional mismatch could have led to the changes of water use, especially among provinces with high incentives for excess water use. Specifically, we modeled individual provincial decision-making in water resources before quota execution.
