...
\abstract[ABSTRACT]{\input{../abstract.tex}}

\keywords{\input{../keywords.tex}}
\maketitle

\section{INTRODUCTION}\label{intro}
\input{main/01_introduction.tex}
