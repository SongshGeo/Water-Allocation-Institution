...
%    \caption{
%        Effects of two institutional shifts on water resources use and allocation in the Yellow River Basin (YRB). \textbf{A}: water uses of the YRB before and after the institutional shift in 1987 (87-WAS); \textbf{A}: water uses of the YRB before and after the institutional shift in 1998 (98-UBR). While the blue lines are observed data, gray ones are estimated by the Differenced Synthetic Control method with economic and environmental background controlled. \textbf{C}
%    }
%    \label{main_results}
%\end{figure*}
...
%Detailed methods are given inthe online supplementary material.
