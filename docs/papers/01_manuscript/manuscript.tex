...
\section{S2: Methods in detials}\label{secS2}
\input{../02_appendix/02_method_details.tex}

\section{S3: Discussions on the 87-WAS}\label{secS3}
\input{../02_appendix/03_results_appendix.tex}

\section{S4: Marginal revenue model}\label{secS4}
\input{../02_appendix/04_theoretical_model.tex}

\section{S5: Model extensions}\label{secS5}
