...
To better understand how water governance institutions match/mismatch their social-ecological context, we take the Yellow River Basin (YRB), China, as an example (see \textit{\nameref{sec:yrb}}) to dive into causal links between SES structures and outcomes.
