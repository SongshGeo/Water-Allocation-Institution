...
To interpret this pattern, we compared the theoretical marginal returns and optimal water use under three different structural cases theoretically where the water using structure between 1987 and 1998 is the largest-consuming case (\ref{secS4}).
