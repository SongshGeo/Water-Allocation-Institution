...
Until water-use decisions are consolidated into unified management (case 3), each stakeholder’s expectation that current water use helps bargain for a favorable water quota may intensify the incentive to use water (case 2), leading to higher water use than that of the past decentralized situation (case 1).
Furthermore, in case 2, the water users with higher capability are more stimulated by the institutional shift and away from the theoretically optimal water use under a unified allocation.
