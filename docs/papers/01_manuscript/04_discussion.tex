...
As both of the institutional shifts examined here induced unexpected changes or cascading effects within SESs, better governance is calling for more institutional analysis of coupled human and natural systems in the future. 

The structural building blocks (or motifs) we depicted here (Figure~\ref{fig:structure}) have also been reported in other SESs worldwide \cite{kluger2020,guerrero2015,bodin2012}.
