...
From these perspectives, two scenarios based on the marginal benefit model (see \textit{Appendix \nameref{secS5}}) can inspire institutional design on how to reduce mismatches.
...
Calls for a redesign of water allocation institutions in the YRB in recent years also illustrate the importance of institutional solutions for sustainability (see \textit{Appendix \nameref{secS1}}) \cite{yu2019}.
